...
### 8.4 Дополнительная функциональность

| Функция | Статус | Описание |
|---------|--------|---------|
| Модуль уведомлений | ⏳ Планируется | Email/SMS-оповещения учеников и сотрудников |
| Интеграция платежей | ⏳ Планируется | Реальные системы оплаты (Яндекс.Касса, Sberbank) |
| Мобильное приложение | ⏳ Планируется | React Native или Flutter |
...
- **Docker для Python**: https://docs.docker.com/language/python/
...
- Email: support@schoolcanteen.ru
- GitHub Issues: https://github.com/your-org/school-canteen/issues
- Документация: https://docs.schoolcanteen.ru
