...
**Название команды**: **MorgeTeam**

**Участники**:
- **Дворников Юрий** — Backend разработка
- **Пузырёв Александр** — Frontend разработка  
- **Хицкий Николай** — Документация
- **Борисов Николай** — Схема базы данных
- **Лю Евгений** — Видео демонстрация

**Ссылка на видео**: https://rutube.ru/video/761406adb0162f9403e636f97fdfd41e/?r=a/
